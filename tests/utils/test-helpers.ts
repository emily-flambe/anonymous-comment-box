      ...
      <form id="feedbackForm" class="feedback-form">
        ...
        <div class="rate-limit-display" id="rateLimitDisplay">
          ...
          <div class="rate-limit-bar">
            <div class="rate-limit-fill" id="rateLimitFill" style="width: 100%; background-color: rgb(16, 185, 129);"></div>
          </div>
        </div>
...
export const simulateAPIError = (errorMessage: string, status = 500) => {
  (global.fetch as any) = vi.fn().mockRejectedValue(new Error(errorMessage));
};
