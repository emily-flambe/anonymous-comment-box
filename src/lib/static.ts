    ...
    <div class="container">
        ...
        <div class="debug-section">
            ...
            <div class="debug-buttons">
                <button class="debug-btn" onclick="checkTokenStatus()">Check Token Status</button>
                <button class="debug-btn" onclick="checkEmailStatus()">Check Email Status</button>
